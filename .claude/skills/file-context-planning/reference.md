...
- **Claude Note (Tools):** Claude CLI can run multiple tool calls and can parallelize safe reads. Use parallelism for speed, but keep planning files updated so state doesn't drift.
