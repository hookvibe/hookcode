...
bash .claude/skills/file-context-planning/scripts/init-session.sh "$SESSION_HASH" "morning-exercise-research"
# (Alternative) Copy templates from .claude/skills/file-context-planning/templates/
```
