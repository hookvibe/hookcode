...
#
# Usage:
#   bash .claude/skills/file-context-planning/scripts/append-changelog.sh "<session-hash>" "<one-line-summary>"
#   printf '%s' "<one-line-summary>" | bash .claude/skills/file-context-planning/scripts/append-changelog.sh "<session-hash>"
#
# Output:
...
if [ -z "${SESSION_HASH}" ]; then
    ...
    echo "Usage:"
    echo "  bash .claude/skills/file-context-planning/scripts/append-changelog.sh \"<session-hash>\" \"<one-line-summary>\""
    echo "  printf '%s' \"<one-line-summary>\" | bash .claude/skills/file-context-planning/scripts/append-changelog.sh \"<session-hash>\""
    exit 1
fi
