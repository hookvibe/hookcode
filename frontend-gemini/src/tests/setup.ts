...
if (typeof window !== 'undefined') {
  // Browser APIs required by legacy UI / rc-virtual-list (missing in JSDOM by default).
  ...
  // legacy UI X Bubble.List uses IntersectionObserver to track "is at bottom" state for auto-scroll.
