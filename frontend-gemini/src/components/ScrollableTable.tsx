 ...
 *
 * Usage:
 * - Prefer `ScrollableTable` over raw tables to avoid squeezed columns. docs/en/developer/plans/frontendgemini-migration-20260127/task_plan.md frontendgemini-migration-20260127
 *
 * Change record:
...
export const ScrollableTable = <RecordType extends object>({
  ...
  return (
    <div className={className}>
      {/* Default to a compact table density to match legacy UI docs and reduce visual heaviness. docs/en/developer/plans/qh23ler2y5yeesg6hqel/task_plan.md qh23ler2y5yeesg6hqel */}
