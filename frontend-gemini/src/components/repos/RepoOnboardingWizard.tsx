...
import { Alert, Button, Card, Input, Radio, Select, Skeleton, Space, Steps, Tag, Typography } from '@/ui';
import { ArrowRightOutlined, CheckOutlined, ReloadOutlined, SendOutlined } from '@/ui/icons';
