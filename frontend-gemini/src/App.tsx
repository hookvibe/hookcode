 ...
 * - 2026-01-12: Tune legacy UI global tokens (radius) so default components match the modern UI style.
 */
...
function App() {
  ...
  useEffect(() => {
    if (typeof document === 'undefined') return;
    // Apply accent colors as CSS variables so custom CSS and legacy UI tokens stay consistent.
  ...
  // Apply custom UI providers without legacy UI theme tokens. docs/en/developer/plans/frontendgemini-migration-20260127/task_plan.md frontendgemini-migration-20260127
  return (
    <ConfigProvider>
      <AppShell
        route={route}
