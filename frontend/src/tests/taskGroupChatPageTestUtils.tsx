...
vi.mock('../api', () => {
  ...
  return {
    ...
    fetchWorkers: vi.fn(async () => [{ id: 'w1', name: 'Worker 1', kind: 'remote', status: 'online', maxConcurrency: 1, currentConcurrency: 0, createdAt: mockNow, updatedAt: mockNow }]),
...
export const setupTaskGroupChatMocks = () => {
  ...
  vi.mocked(api.fetchWorkers).mockResolvedValue([
    { id: 'w1', name: 'Worker 1', kind: 'remote', status: 'online', maxConcurrency: 1, currentConcurrency: 0, createdAt: NOW, updatedAt: NOW } as any
  ]);
