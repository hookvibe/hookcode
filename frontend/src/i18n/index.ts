 ...
 *
 * Change record:
 * - 2026-01-11: Added a minimal, dependency-free i18n implementation aligned with Ant Design locale.
 */
...
export const getAntdLocale = (locale: Locale): AntdLocale => {
  // antd locale package names use underscores: en_US / zh_CN
