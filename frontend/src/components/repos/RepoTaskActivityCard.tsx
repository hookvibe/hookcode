...
// Keep repository activity charts aligned with the stop-only task lifecycle. docs/en/developer/plans/taskgroup-ui-refactor-20260306/task_plan.md taskgroup-ui-refactor-20260306
...
export const RepoTaskActivityCard: FC<RepoTaskActivityCardProps> = ({ repoId }) => {
  ...
  const refresh = useCallback(async () => {
    ...
    setLoadFailed(false);
    try {
      const [nextStats, nextTasksResponse] = await Promise.all([
      ...
      // Unwrap task list payload from paginated response. docs/en/developer/plans/pagination-impl-20260227/task_plan.md pagination-impl-20260227
      const nextTasks = nextTasksResponse.tasks;
      setStats(nextStats);
