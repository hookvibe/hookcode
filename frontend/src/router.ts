...
export type SettingsTab = 'account' | 'credentials' | 'tools' | 'environment' | 'approvals' | 'costs' | 'settings' | 'logs' | 'notifications' | 'preview' | 'webhooks' | 'workers'; // Add worker registry routing to the settings page for executor management. docs/en/developer/plans/worker-executor-refactor-20260307/task_plan.md worker-executor-refactor-20260307
...
export const SETTINGS_TABS: SettingsTab[] = ['account', 'credentials', 'tools', 'environment', 'approvals', 'costs', 'settings', 'logs', 'notifications', 'preview', 'webhooks', 'workers'];
