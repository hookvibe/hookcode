...
// Install preview dependencies when highlight commands cannot run. docs/en/developer/plans/3ldcl6h5d61xj2hsu6as/task_plan.md 3ldcl6h5d61xj2hsu6as
const HELP_TEXT = `Hookcode Preview Dependency Install

Usage:
  node scripts/preview_dependencies_install.mjs --task-group <id>
...
async function main() {
  ...
  const url = buildUrl(baseUrl, `/api/task-groups/${taskGroupId}/preview/dependencies/install`);
