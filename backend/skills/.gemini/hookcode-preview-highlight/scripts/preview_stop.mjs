...
// Stop preview instances after highlight verification. docs/en/developer/plans/3ldcl6h5d61xj2hsu6as/task_plan.md 3ldcl6h5d61xj2hsu6as
const HELP_TEXT = `Hookcode Preview Stop

Usage:
  node scripts/preview_stop.mjs --task-group <id>
...
async function main() {
  ...
  const url = buildUrl(baseUrl, `/api/task-groups/${taskGroupId}/preview/stop`);
