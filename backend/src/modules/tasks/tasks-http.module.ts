...
@Module({
  ...
  // Import WorkersModule so TasksController can resolve the worker connection registry directly in the HTTP module context. docs/en/developer/plans/worker-executor-refactor-20260307/task_plan.md worker-executor-refactor-20260307
  imports: [TasksModule, RepositoriesModule, SkillsModule, LogsModule, WorkersModule],
