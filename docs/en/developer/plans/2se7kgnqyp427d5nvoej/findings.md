# Findings & Decisions: preview iframe sandbox and toolbar
...
{/* Link discoveries to code changes via this session hash. 2se7kgnqyp427d5nvoej */}
...
- Add an embedded browser toolbar above the preview iframe (back/forward/refresh/address bar).
