# Task Plan: Swagger启动方式
{/* WHAT: This is your roadmap for the entire task. Think of it as your "working memory on disk." WHY: After 50+ tool calls, your original goals can get forgotten. This file keeps them fresh. WHEN: Create this FIRST, before starting any work. Update after each phase completes. */}

{/* Track code changes with this session hash for traceability. p1qnl1d63n6c7wiob2wt */}
...
确定当前项目启动 Swagger 的方式（命令/配置/访问地址），并提供清晰的启动说明。
<!-- Record the Swagger startup goal and phase updates for this session. docs/en/developer/plans/p1qnl1d63n6c7wiob2wt/task_plan.md p1qnl1d63n6c7wiob2wt -->
...
- [x] Identify relevant project files and docs
...
- [x] Provide the Swagger startup steps
- [x] Validate against repo configuration
- [x] Test incrementally (if applicable)
- **Status:** complete
...
1. Swagger 在项目中通过哪一处配置/中间件启用？
2. 启动 Swagger 需要运行哪些命令与访问哪个地址？

## Decisions Made
{/* WHAT: Technical and design decisions you've made, with the reasoning behind them. WHY: You'll forget why you made choices. This table helps you remember and justify decisions. WHEN: Update whenever you make a significant choice (technology, approach, structure). EXAMPLE: | Use JSON for storage | Simple, human-readable, built-in Python support | */}
| Decision | Rationale |
|----------|-----------|
| 依据 Admin Tools 启动入口与配置说明 Swagger 启动方式。 | Swagger UI 由 Admin Tools 负责启动，环境变量与脚本能准确描述启动步骤与访问地址。 |
