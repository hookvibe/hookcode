# Task Plan: Fix repo activity title overflow
{/* WHAT: This is your roadmap for the entire task. Think of it as your "working memory on disk." WHY: After 50+ tool calls, your original goals can get forgotten. This file keeps them fresh. WHEN: Create this FIRST, before starting any work. Update after each phase completes. */}

{/* Track code changes with this session hash for traceability. repo-activity-title-overflow-20260227 */}
...
Ensure repo activity items handle long titles without shrinking or overlapping the left-side hash ID.
...
1. Which component renders the repo activity list and title/hash layout?
2. What CSS constraints currently allow the title to compress the hash, and what minimal fix preserves layout on long titles?

## Decisions Made
{/* WHAT: Technical and design decisions you've made, with the reasoning behind them. WHY: You'll forget why you made choices. This table helps you remember and justify decisions. WHEN: Update whenever you make a significant choice (technology, approach, structure). EXAMPLE: | Use JSON for storage | Simple, human-readable, built-in Python support | */}
| Decision | Rationale |
|----------|-----------|
| Add a dedicated class on the commit hash and prevent it from shrinking in the flex row. | Keeps the short hash readable while allowing the title to ellipsize when space is tight. |
| Add a repo detail test that asserts the commit hash wrapper class is present with long titles. | Protects the overflow fix behavior via DOM-level regression coverage. |
