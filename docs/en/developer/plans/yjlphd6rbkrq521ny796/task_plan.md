...
<!-- 
  WHAT: Emit diff artifacts from backend so the web UI can render rich diffs.
  WHY: Codex JSONL file_change events do not include diff bodies; backend needs to attach diffs.
-->
