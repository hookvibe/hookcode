...
Restructure task-group workspaces to use a taskgroup-id directory containing the repo clone and Codex artifacts, update command execution to run inside that folder, and document the new layout.
...
<!-- Implementation finished; move to verification. docs/en/developer/plans/taskgroups-reorg-20260131/task_plan.md taskgroups-reorg-20260131 -->
- **Status:** complete
...
<!-- Testing complete; prepare delivery steps. docs/en/developer/plans/taskgroups-reorg-20260131/task_plan.md taskgroups-reorg-20260131 -->
- **Status:** complete
...
- [x] Deliver to user
<!-- Delivery checklist completed for task-group workspace update. docs/en/developer/plans/taskgroups-reorg-20260131/task_plan.md taskgroups-reorg-20260131 -->
- **Status:** complete
