...
1. How are auto-generated TaskGroup PATs currently distinguished from user-created PATs in data/API?
2. Which UI surfaces exist for PAT management (panel vs repository settings), and where should the new auto-generated area live?
3. Do we need to migrate existing data or only filter/display based on metadata?
