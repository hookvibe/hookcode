# Task Plan: Analyze noisy test output
{/* WHAT: This is your roadmap for the entire task. Think of it as your "working memory on disk." WHY: After 50+ tool calls, your original goals can get forgotten. This file keeps them fresh. WHEN: Create this FIRST, before starting any work. Update after each phase completes. */}

{/* Track code changes with this session hash for traceability. test-output-noise-20260129 */}
...
Analyze the test output warnings/errors and identify their causes and recommended fixes or suppressions.
...
1. Which test or mock setup is missing `fetchTaskGroupPreviewStatus` export?
2. Are the backend console warnings expected, and where are they triggered?
3. Do we want to suppress these logs in tests or treat them as failures?

## Decisions Made
{/* WHAT: Technical and design decisions you've made, with the reasoning behind them. WHY: You'll forget why you made choices. This table helps you remember and justify decisions. WHEN: Update whenever you make a significant choice (technology, approach, structure). EXAMPLE: | Use JSON for storage | Simple, human-readable, built-in Python support | */}
| Decision | Rationale |
|----------|-----------|
| Add missing API mock export and suppress known test-only console noise. | Keeps test output clean without altering production behavior. |
