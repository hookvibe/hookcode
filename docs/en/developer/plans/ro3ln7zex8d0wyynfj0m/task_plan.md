# Task Plan: Replace loading spinners with skeletons
{/* WHAT: This is your roadmap for the entire task. Think of it as your "working memory on disk." WHY: After 50+ tool calls, your original goals can get forgotten. This file keeps them fresh. WHEN: Create this FIRST, before starting any work. Update after each phase completes. */}

{/* Track code changes with this session hash for traceability. ro3ln7zex8d0wyynfj0m */}
...
Replace frontend content-loading spinners/Empty placeholders with Ant Design Skeleton-based skeleton screens across the main UI, and add a frontend rule requiring skeletons for waiting states.
...
1. Which loading states are "content waiting" (skeleton) vs "action in progress" (button loading/spinner)?
2. Can we implement reusable skeleton components to keep UX consistent across pages (lists/detail/chat/tables)?
3. What is the minimal a11y/test surface (aria-busy/testid) to verify skeletons appear/disappear?

## Decisions Made
{/* WHAT: Technical and design decisions you've made, with the reasoning behind them. WHY: You'll forget why you made choices. This table helps you remember and justify decisions. WHEN: Update whenever you make a significant choice (technology, approach, structure). EXAMPLE: | Use JSON for storage | Simple, human-readable, built-in Python support | */}
| Decision | Rationale |
|----------|-----------|
| Use AntD `Skeleton` for loading UIs | Already a dependency (`antd@^6`), consistent styling, and supports rich placeholders |
| Add small reusable skeleton components under `frontend/src/components/skeletons/*` | Avoid copy-paste and keep loading UX consistent across pages |
| Keep button `loading` spinners for mutations | Action feedback differs from content loading; skeleton is for "data not ready" states |
