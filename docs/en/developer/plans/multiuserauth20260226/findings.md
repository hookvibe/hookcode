...
<!-- Locale messages live in frontend/src/i18n/messages/{zh-CN.ts,en-US.ts}. docs/en/developer/plans/multiuserauth20260226/task_plan.md multiuserauth20260226 -->
...
<!-- Auth locale keys live in frontend/src/i18n/messages/{zh-CN,en-US}/auth.ts. docs/en/developer/plans/multiuserauth20260226/task_plan.md multiuserauth20260226 -->
- Auth locale keys live in `frontend/src/i18n/messages/{zh-CN,en-US}/auth.ts`.
<!-- Repo locale keys live in frontend/src/i18n/messages/{zh-CN,en-US}/repos.ts for member/invite copy. docs/en/developer/plans/multiuserauth20260226/task_plan.md multiuserauth20260226 -->
