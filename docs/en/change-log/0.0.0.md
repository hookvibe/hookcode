...
- Replace raw live task logs with a structured Codex execution viewer (JSONL parsing) and backend-emitted diff artifacts. ([yjlphd6rbkrq521ny796](../developer/plans/yjlphd6rbkrq521ny796/task_plan.md))

- Auto-sync docs.json plan navigation on session init. ([docsjsonindex20260121](../developer/plans/docsjsonindex20260121/task_plan.md))

- Add credential-based model discovery APIs and reusable UI picker so codex/claude_code/gemini_cli models are no longer hardcoded. ([b8fucnmey62u0muyn7i0](../developer/plans/b8fucnmey62u0muyn7i0/task_plan.md))

- Translate all docs/en Markdown files to English. ([docsentrans20260121](../developer/plans/docsentrans20260121/task_plan.md))

- Repo detail: add full-width provider activity row (commits/merges/issues) with per-column pagination, commit short SHA, issue state/updated time, and task-group + processing-task links (anonymous/public + credential selection for private). ([kzxac35mxk0fg358i7zs](../developer/plans/kzxac35mxk0fg358i7zs/task_plan.md))

- Update docs workflow (versioning + doc-sync rules) and add User Docs + Open API Reference pages with Mintlify navigation. ([docsworkflowapi20260121](../developer/plans/docsworkflowapi20260121/task_plan.md))
