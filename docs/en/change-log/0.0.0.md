...
- nn62s3ci1xhpr7ublh51: Repo dashboard Task activity trend chart now uses ECharts (with tests + theme-aware styling). ([plan](../developer/plans/nn62s3ci1xhpr7ublh51/task_plan.md))

- 3iz4jx8bsy7q7d6b3jr3: Tasks page: redesign list header/toolbar and surface active status filter with a stats-driven summary strip. ([plan](../developer/plans/3iz4jx8bsy7q7d6b3jr3/task_plan.md))
